...
from DistribuidoraCarne.validaciones import validar_Total_Cotizacion,validar_numero_tarjeta,validar_fecha_vencimiento,validar_cvv,validar_valor_impuesto,validar_nombre_titular,validar_nombre_negocio,validar_documento_identidad
...
# Aqui trabajo Javier y se estan agregando los models de impuesto, metodo de pago y encabezado de factura
...
#este model va relacionado con surcusal, tiene que mandar a llamar nombre surcusal y direccion del negocio
